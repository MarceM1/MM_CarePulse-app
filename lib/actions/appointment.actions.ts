...
export const getRecentAppointmentList = async () => {
  try {
    ...
    console.log("getRecenteAppointmentList error: ", error);
  }
};
  ...
  try {
    ...
    ${
      type === "schedule"
        ...
        : `We regret to inform you that your appointment has been cancelledfor the following reason: ${appointment.cancellationReason}`
    }
    `;
    ...
    console.log("Error en updateAppointment: ", error);
  }
};
...
export const sendSMSNotification = async (userId: string, content: string) => {
  try {
    ...
    console.log("Error en sndSMSNotification: ", error);
  }
};
